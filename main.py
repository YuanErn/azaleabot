...
async def nowStreaming(ctx):
    ...
    embed.add_field(name="{0} [fin3sss] (https://www.twitch.tv/fin3sss)".format(currentlyOnline[1]), value="My name is Brandon also known as 'Fin3Ss' (Finesse). In the year of 2021 I am 15. I am just an ordinary cool guy that plays every game and its good at it :)")
